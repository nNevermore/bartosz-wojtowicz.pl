        ...
        <div className="flex flex-col-reverse lg:flex-row items-center gap-12">
          <div className="flex-1 space-y-8 text-center lg:text-left">
            <div className="inline-block px-4 py-1.5 rounded-full glass-panel text-sm font-medium text-primary mb-2">
              Gotowy na nowe wyzwania (Frontend Developer / React)
            </div>
            ...
            <p className="text-lg md:text-xl text-slate-400 max-w-2xl mx-auto lg:mx-0">
              Frontend & Fullstack Developer. Od portali społecznościowych, przez automatyzację w grach, aż po wielodomenowe aplikacje e-commerce. Wieloletnią pasję przekuwam w czysty, skalowalny kod. Specjalizuję się w ekosystemie React / TypeScript i budowie nowoczesnych interfejsów webowych.
            </p>
